"""Event candidate-promotion CLI handler."""
...
async def _research_campaign_promote_event_candidates(
    ...
    slug = str(
        ...
        or f"{result.get('event_feature_set_version', 'event')}_candidate_promotion"
    )
    diagnostics_root = output_root / "diagnostics" / slug
    diagnostics_root.mkdir(parents=True, exist_ok=True)
    result_path = diagnostics_root / "event_candidate_promotion.json"
...
__all__ = ["_research_campaign_promote_event_candidates"]
