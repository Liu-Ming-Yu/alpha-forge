...
from quant_platform.services.research_service.features.kernel.formulaic.ast import Expression, Var
...
if TYPE_CHECKING:
    from quant_platform.services.research_service.features.kernel.contracts import FeatureDirection
